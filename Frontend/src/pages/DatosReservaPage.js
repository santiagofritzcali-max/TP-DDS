...
const DatosReservaPage = () => {
  ...
  const validarFormulario = () => {
    ...
    if (!telTrim) {
      ...
      errors.telefono =
        "El campo Nro. Teléfono solo admite números (sin guiones ni caracteres especiales).";
      esValido = false;
    }
          ...
          >
            ...
            <div className="datos-field">
              ...
              <input
                ...
                name="nombre"
                type="text"
                className={`input datos-input ${fieldErrors.nombre ? "input-error" : ""}`}
                value={form.nombre}
            ...
            <div className="datos-field">
              ...
              <input
                ...
                name="apellido"
                type="text"
                className={`input datos-input ${fieldErrors.apellido ? "input-error" : ""}`}
                value={form.apellido}
                onChange={handleChange}
              />
            ...
            {/* Teléfono */}
            <div className="datos-field">
              <label className="datos-label" htmlFor="telefono">
              ...
              <input
                ...
                inputMode="numeric"
                pattern="[0-9]*"
                className={`input datos-input ${fieldErrors.telefono ? "input-error" : ""}`}
                value={form.telefono}
                onChange={handleChange}
              />
